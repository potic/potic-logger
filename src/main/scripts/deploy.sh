...
docker run -dit --name potic-logger --link potic-users -e LOG_PATH=/mnt/logs -v /mnt/logs:/mnt/logs -e LOGZIO_TOKEN=$LOGZIO_TOKEN -p 40410:8080 potic/potic-logger:$TAG_TO_DEPLOY
